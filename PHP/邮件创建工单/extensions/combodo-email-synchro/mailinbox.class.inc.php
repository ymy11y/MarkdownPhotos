...
abstract class MailInboxBase extends cmdbAbstractObject
{
	...
	public static function Init()
	{
		...
		// Bill 20170721 modify allowed value for protocol, add exchange, affect table mailinbox_base
		MetaModel::Init_AddAttribute(new AttributeEnum("protocol", array("allowed_values"=>new ValueSetEnum('pop3,imap,exchange'), "sql"=>"protocol", "default_value"=>'pop3', "is_null_allowed"=>false, "depends_on"=>array())));
